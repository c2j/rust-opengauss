...
impl GaussdbMcp {
    ...
    async fn get_client_for(
        ...
        match conns.get(&name) {
            Some(ConnectionState::Connected {
                ...
                // concurrent callers don't also race to reconnect.
                info!(
    ...
    /// Downgrade a Connected connection to Connecting after a query error,
